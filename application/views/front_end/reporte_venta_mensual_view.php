<?php 
    ...
    for ($i = date('Y'); $i > 2014 ; $i--) { 
        $opciones_gestion_vm[$i] = $i;
    }

    $atributos_gestion_vm = 'id="gestion_vm" class="form-control"';
?>
<section class="row clearfix">
    <div class="col-md-12 column">
        ...
        <div class="row clearfix filtros_reporte ">  
            <?= form_open('', $atributos_form) ?>
                ...
                <div class="col-md-2 column frm-pharma">
                    <?= form_dropdown('gestion_vm', $opciones_gestion_vm, set_value('gestion_vm',date('Y')), $atributos_gestion_vm) ?>
                </div>                
            <?= form_close() ?>
        </div>
        <hr />
        <div class="row clearfix">  
            <div class="col-md-12 column">
                <label class="lbl-pharma">Venta Mensual - <span id="titulo_vm"></span></label>
            </div>
        </div> 

        <div class="row clearfix"> 
            <div class="col-md-5 column table-responsive">
                <table id="tblVentaMensual" class="table table-hover table-striped tblReporte">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Cantidad</th>
            ...
            <div class="col-md-6 column">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="cantidad">
                        <div id="grafica_cantidad_vm"></div>
                    </div>
                    <div role="tabpanel" class="tab-pane fade" id="ganancias">
                        <div id="grafica_ganancias_vm"></div>
                    </div>            
                </div>    
            </div>
        </div>        
