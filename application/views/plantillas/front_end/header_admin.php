                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="<?= base_url() ?>lista_laboratorios">Laboratorios</a>
                                </li>
                                <li>
                                    <a href="#">Sucursales</a>
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>lista_usuarios">Usuarios</a>
                                </li>
                                <li class="divider">
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>lista_clientes">Clientes</a>
                                </li>
                                <li class="divider">
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>lista_productos">Productos</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="<?= base_url() ?>venta_diario">Venta Diario</a>
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>venta_mensual">Venta Mensual</a>
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>venta_anual">Venta Anual</a>
                                </li>
                                <li class="divider">
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>top_productos">Top de Productos</a>
                                </li>
                                <li class="divider">
                                </li>
                                <li>
                                    <a href="<?= base_url() ?>rentabilidad_trimestral">Rentabilidad Producto Trimestral</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
